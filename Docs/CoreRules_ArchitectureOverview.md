...
Feet Plan 与 Feet FormulaResolver Input Assembler 均已关闭，不等于 Through Ball Feet 可执行或完整 Through Ball 完成。Formula execution、实际 Goal / Miss、attack-end mutation、Consumer / Composition / MatchPlay、Behind Defense、Anti-Offside、One-on-One Handoff / Entry 均延后。下一入口为 `7.25 Part 6 Next Capability Selection + Minimum Contract Review`（Report-only / Capability Selection + Minimum Contract Review），不预选具体实现。
