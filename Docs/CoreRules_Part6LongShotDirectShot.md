...
- Cut Inside Shot 当前已具备 Direct Shot 与 Dead Corner 两个独立最小分支能力。
- Cut Inside Shot 当前未实现 Branch Selection 或完整内切射门。
...
下一阶段必须由后续提示词明确，不从 6.25.5 Docs Sync 自动扩大范围。
