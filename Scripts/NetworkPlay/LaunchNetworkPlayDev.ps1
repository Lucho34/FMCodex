...
param(
    ...
    [ValidateSet('DirectGoal', 'DirectMiss', 'ImmediateMiss', 'DeadCornerGoal', 'DeadCornerMiss')][string]$PlayerFacingLongShotMilestone,
...
function Get-NetworkPlayLaunchPlan {
    ...
    if ($PlayerFacingCrossMilestone -or $PlayerFacingPassControlMilestone -or $PlayerFacingThroughBallFeetMilestone -or $PlayerFacingThroughBallMilestone -or $PlayerFacingLongShotMilestone -or $PlayerFacingCutInsideMilestone -or $PlayerFacingDeclineMilestone -or $PlayerFacingSetPieceMilestone -or $PlayerFacingNearFreeKickMilestone -or $PlayerFacingLongFreeKickMilestone) {
        ...
        if ($PlayerFacingLongFreeKickMilestone) {
        ...
        } elseif ($PlayerFacingNearFreeKickMilestone) {
            $fixtureArguments = @(('-FMCodexNetworkPlayerFacingNearFreeKickMilestone=' + $PlayerFacingNearFreeKickMilestone), ('-FMCodexNetworkSetPieceActor=' + $SetPieceActor))
        } elseif ($PlayerFacingSetPieceMilestone) {
            ...
            $shotFamily = if ($PlayerFacingLongShotMilestone) { 'LongShot' } else { 'CutInside' }
            $shotMode = if ($PlayerFacingLongShotMilestone) { $PlayerFacingLongShotMilestone } else { $PlayerFacingCutInsideMilestone }
            $fixtureArguments = @(('-FMCodexNetworkPlayerFacing' + $shotFamily + 'Milestone=' + $shotMode), ('-FMCodexNetworkShotActor=' + $ShotActor))
            if ($ShotFinal) { $fixtureArguments += '-FMCodexNetworkShotFinal' }
        } elseif ($PlayerFacingThroughBallMilestone) {
            ...
            $fixtureArguments = @('-FMCodexNetworkPlayerFacingThroughBallFeetMilestone=' + $PlayerFacingThroughBallFeetMilestone)
        } else {
    ...
    if ($InitialRouteMilestone) {
        $fixtureArguments = @('-FMCodexNetworkRouteMilestone=' + $InitialRouteMilestone)
        if ($InitialRouteMilestone -ne 'Cross') { $fixtureArguments += '-FMCodexNetworkTestBFirst' }
    }
    if ($DeploymentSlice) {
