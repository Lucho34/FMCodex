	...
	const FString& Parameters)
{
	...
	TestEqual(TEXT("Authoritative Session exposes 80 typed serialized entrypoints including Long Free Kick"),
		SerializedEntrypointCount, 80);
	...
	const FString& Parameters)
{
	...
	TestEqual(TEXT("Authority typed serialized entrypoint contract includes Long Free Kick"),
		SerializedEntrypointCount, 80);
	...
	const FString& Parameters)
{
	...
	const int32 SerializedEntrypointCount = SessionCountSource.ReplaceInline(
		TEXT("ExecuteSerialized<"), TEXT(""), ESearchCase::CaseSensitive);
	TestEqual(TEXT("Authority typed serialized entrypoint includes Long Free Kick"),
		SerializedEntrypointCount, 80);
