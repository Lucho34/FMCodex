...
bool FFMCodexOptionalDeclineWire::RunTest(const FString&)
{
 ...
 for(int32 Value=51;Value<256;++Value){Envelope E;E.IntentKind=static_cast<Kind>(Value);TestEqual(TEXT("Unallowlisted/internal wire tags fail closed"),E.ValidatePayloadShape(),Code::NotPlayerIntent);}
