...
bool FFMCodexNetworkIntentSurfaceTest::RunTest(const FString&)
{
	...
	ExactFields(FFMCodexNetworkCrossTerminalFact::StaticStruct(), {TEXT("Outcome"), TEXT("Goal")});
	...
	ExactFields(FFMCodexNetworkCrossContestFact::StaticStruct(), {TEXT("AttackD6"), TEXT("DefenseD6"), TEXT("bFormulaResolved")});
