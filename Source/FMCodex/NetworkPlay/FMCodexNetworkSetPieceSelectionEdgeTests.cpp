...
bool FFMCodexSetPieceWire::RunTest(const FString&)
{
 ...
 for(int32 Value=54;Value<256;++Value){Envelope E;E.IntentKind=static_cast<Kind>(Value);TestEqual(TEXT("Unknown/internal tags remain closed"),E.ValidatePayloadShape(),Code::NotPlayerIntent);}
